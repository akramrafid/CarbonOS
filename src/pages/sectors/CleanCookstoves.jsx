  ...
  return (
    <div className="pt-24 pb-16 min-h-[80vh] flex flex-col items-center noise-overlay">
      <div className="w-full bg-[#040A06] border-b border-emerald/10 py-16 px-6 lg:px-12 relative overflow-hidden flex flex-col items-center justify-center text-center">
        ...
        <h1 className="serif-drama text-[56px] lg:text-[72px] text-white leading-tight mb-4 z-10">Clean Cookstoves</h1>
        <p className="font-sans text-lg text-mist max-w-2xl z-10">Distributing efficient thermal devices to reduce biomass consumption and deforestation.</p>
      </div>
          ...
          <div className="space-y-6 font-sans text-mist text-base leading-relaxed">
            ...
            <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-5 bg-[#040A06] border border-emerald/10 rounded-xl">
                ...
                <div className="font-sans font-bold text-registry">Gold Standard TPD</div>
              </div>
              <div className="p-5 bg-[#040A06] border border-emerald/10 rounded-xl">
                <div className="font-mono text-[10px] text-amber mb-2">DATA REQUIREMENT</div>
                <div className="font-sans font-bold text-registry">Usage Surveys & KPTs</div>
              </div>
            </div>
          </div>
        </div>
...
export default CleanCookstoves;
