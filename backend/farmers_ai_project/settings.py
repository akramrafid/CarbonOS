"""
Django settings for farmers_ai_project project.
...
WSGI_APPLICATION = 'farmers_ai_project.wsgi.application'
ASGI_APPLICATION = 'farmers_ai_project.asgi.application'
