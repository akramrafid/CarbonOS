...
- [x] **P1-T001** Produce structured capability map
...
- [x] **P1-T002** Write PRD, prioritized stories, and non-goals
...
- [x] **P1-T003** Personas, journeys, and task flows
  - **Owner:** ux-researcher
  - **Deps:** P1-T001
...
- [x] **P1-T004** Competitor interaction-pattern analysis
...
- [x] **P1-T005** Visual moodboard and anti-patterns
...
- [x] **P1-T006** Synthesize open questions and conversion copy outline
...
- [x] **P1-T007** Define funnel, north-star metric, and ethical CRO guardrails
...
- [x] **P1-T008** Create privacy-aware product measurement plan
...
- [x] **P1-T009** Define public route and technical SEO contract
...
- [x] **P1-G1** 🧑 HUMAN Approve discovery plan
  - **Owner:** coordinator
